...
static = open('Spitzer.core/config/static.json', 'r').read()
static = json.loads(static)

dynamic = open('Spitzer.core/config/dynamic.json', 'r').read()
dynamic = json.loads(dynamic)

data = open('Spitzer.core/config/data.json', 'r').read()
...
def writeStatic():
    open('Spitzer.core/config/static.json', 'w').write(json.dumps(static))
